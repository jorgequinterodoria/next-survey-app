...
export function ConsentScreen({
  ...
  const canProceed = consentName.trim() !== '' && consentDoc.trim() !== '' && consentAccepted;
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm text-slate-800 bg-white placeholder-slate-400"
          ...
          <div className="bg-slate-50 rounded-xl p-4 space-y-3">
            <h3 className="text-sm font-semibold text-slate-800">Declaración de Consentimiento</h3>
